...
public class Shop {
	...
	private void registerTransaction(String dd_mm_yyyy, Customer customer, Car car, double discount) {
		transactions.add(new Transaction(dd_mm_yyyy, customer, car, discount));
	}
